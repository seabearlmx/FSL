...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--LB", type=float, default=0.01, help="beta for FDA")  # not use in FSL
        ...
        parser.add_argument("--snapshot-dir", type=str, default='./checkpoints/FSL', help="Where to save snapshots of the model.")
        parser.add_argument("--data-dir", type=str, default='./datasets/GTA5/data', help="Path to the directory containing the source dataset.")
        ...
        parser.add_argument("--data-dir-target", type=str, default='./datasets/Cityscapes', help="Path to the directory containing the target dataset.")
        ...
        parser.add_argument("--label-folder", type=str, default='target_ssl_gt', help="Path to the directory containing the pseudo labels.")
        ...
        parser.add_argument("--num-steps-stop", type=int, default=250000, help="Number of training steps for early stopping.")
        ...
        # GTA5_init is utilized to train G2C in the ResNet-101 backbone
        # SYNTHIA_init is utilized to train S2C in the ResNet-101 backbone
        # vgg_init is utilized to train G2C and S2C in the VGG-16 backbone
        parser.add_argument("--init-weights", type=str, default='./pretrained/GTA5_init.pth', help="initial model, available options : GTA5_init, SYNTHIA_init and vgg_init.")
